...
def main():
    ...
    with open(out, "w") as f:
        ...
        f.write("\n  ]\n}\n")
    with open(os.path.join(ROOT, "assets", "data", "challenges.json"), "w") as f:
        json.dump({"_comment": "Generated by tools/citygen.py. Timed targets are seconds, score targets points (bronze, silver, gold).",
                   "challenges": challenges}, f, indent=1)
