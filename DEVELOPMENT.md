...
without a controller; `--aa` overrides the anti-aliasing setting (image comparisons); `--debugview` 1 albedo, 2 normals, 3 roughness, 4 occlusion, 5 shadow, 6 specular IBL,
